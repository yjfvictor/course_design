...
{
	var str = "method=del_record&id=" + id;
	try
	{
		...
		httpRequest.open("POST", "changes.php", true );
...
function add_record()
{
	...
	var str = "method=add_record";
	if ( document.getElementById("studentid").value != "" )
		str += "&studentid=" + urlencode(document.getElementById("studentid").value);
	if ( document.getElementById("changes").value != "" )
		str += "&changes=" + urlencode(document.getElementById("changes").value);
	if ( document.getElementById("rec_time").value != "" )
